...
function spacexchimp_p003_load_scripts_admin( $hook ) {
    ...
    $settings_page = 'code_page_code/css';
    ...
    // Other libraries
    wp_enqueue_script( $plugin['prefix'] . '-bootstrap-checkbox-js', $plugin_combo['url'] . 'inc/lib/bootstrap-checkbox.js', array(), $plugin['version'], false );
