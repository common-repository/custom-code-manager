...
function spacexchimp_p016_render_submenu_page() {
    ...
    // Call messages
    spacexchimp_p016_message_hello();
    spacexchimp_p016_message_error_version();
    spacexchimp_p016_message_save();
    ...
    <div class="wrap">
        ...
        <h2 class="sxc-header">
            ...
            <p class="version"><?php _e( 'Version', $plugin['text'] ); ?> <?php echo $plugin_combo['version']; ?></p>
        </h2>
        ...
        <div id="poststuff" class="metabox-holder has-right-sidebar">
            ...
            <div class="tab-page fade" id="tab-support">
                <?php require_once( $plugin_combo['path'] . 'inc/php/tabs/support.php' ); ?>
            </div>
            <!-- END-TAB SUPPORT -->
