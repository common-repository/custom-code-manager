            ...
            <div class="meta-box-sortabless">
                ...
                <form action="options.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="postbox" id="head">
                        ...
                        <div class="inside">
                            <p class="note"><?php _e( 'You can use the fields below to add your custom JavaScript code to the HEAD section of your website\'s front end.', $plugin['text'] ); ?></p>

                            <p class='help-text'><?php _e( 'The JavaScript code from this field will be printed at the beginning of the HEAD section.', $plugin['text'] ); ?></p>
                            <textarea
                    ...
                    <div class="postbox" id="footer">
                        ...
                        <div class="inside">
                            <p class="note"><?php _e( 'You can use the fields below to add your custom JavaScript code to the FOOTER section of your website\'s front end.', $plugin['text'] ); ?></p>

                            <p class='help-text'><?php _e( 'The JavaScript code from this field will be printed at the beginning of the FOOTER section.', $plugin['text'] ); ?></p>
                            <textarea
                            ...
                            <!-- HIDDEN -->
                            <?php
                                spacexchimp_p016_control_hidden( 'hidden_scrollto',
                                                                 '0'
                                                               );
                            ?>
                            <!-- END HIDDEN -->
