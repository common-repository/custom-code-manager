 ...
 */
function spacexchimp_p016_message_hello() {
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        <img src="<?php echo $plugin_combo['url'] . 'inc/img/spacexchimp-logo.png'; ?>">
 ...
 */
function spacexchimp_p016_message_error_version() {
 ...
 * Save message
 */
function spacexchimp_p016_message_save() {
